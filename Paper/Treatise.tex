...
ret
	...
	Each benchmark was run on every virtual machine ten times, and the execution time was recorded. The graphs in \reffig{execgraphs} show the execution time in seconds, with the error bars representing the standard deviation. 
